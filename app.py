...
operacoes = ["TIKTOK", "BENNET JEANS", "SHEIN", "NUVEMSHOP", "SHOP FOCO","BITHOME","CUBBO","CANIAO","ESTOCA","EXPRESSIO","FM TRANSPORTES","FRENET","KWAI","LADO ROSA","MAGAZORD","MERCADO LIVRE","MEU RODAPÉ","SATELITAL","ZENATUR","TPL","PRIVALIA","OLIST","MEU LADO ROSA","PME MARISA","ENJOEI","PRINT"]
