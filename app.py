...
usuarios = {
    ...
    "SRM2600221": {"senha":"dPpgHisANVX7wgYD","razao":"CSM LOGISTICA E TRANSPORTES LTDA"},
    ...
    "SRM2602898": {"senha":"SfTbDH9B8TsEWqJb","razao":"MIUK SOLUCOES LOGISTICAS LTDA"},
...
razoes_sociais = [
    ...
    "CARGO LUZ LOGISTICA E TRANSPORTES LTDA",
    "CR LOGISTICA E TRANSPORTES LTDA"
    
]

tipos_veiculos = ["FIORINO", "VAN", "VUC", "CARRO UTILITARIO", "AJUDANTE", "MOTO", "3/4", "CARRETA", "TOCO", "TRUCK"]
operacoes = ["TIKTOK", "BENNET JEANS", "SHEIN", "NUVEMSHOP", "SHOP FOCO","BITHOME","CUBBO","CANIAO","ESTOCA","EXPRESSIO","FM TRANSPORTES","FRENET","KWAI","LADO ROSA","MAGAZORD","MERCADO LIVRE","MEU RODAPÉ","SATELITAL","ZENATUR","TPL","PRIVALIA","OLIST","MEU LADO ROSA","PME MARISA","ENJOEI","PRINT","TT/SHEIN - SALON LINE","TT/SHEIN - MUNDIAL ALUMINIOS","TIKTOK - BIGHOME STORE","TIKTOK - PATETAS PET&BAZAR","PME ENJOEI","PME AFTER CLICK","PME EVINO","PROCESSAMENTO","SELLER T4 T5","Mondial – Araçariguama/SP"]
